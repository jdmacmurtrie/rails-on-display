...
feature "visitors can add art pieces for galleries" do
  scenario "adds a art pieces for a gallery successfully" do
    ...
    expect(page).to have_content "Art Piece Form for The Barnes Foundation"
